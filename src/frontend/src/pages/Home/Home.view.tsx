    ...
    <HomeStyled>
      ...
      <HomePage>
        <HomeContainer>
          ...
          <span>At the end of the 23 modules, you will be handed a completion certificate which grants access to the Ocean Ambassador community. We look forward to see you here.</span>
          <Link to="/chapter-1">
